...
const prod3 = new Productos("3", "GeForce GTX 1050 Ti GAMING X 4G", "placavideo", "Es una tarjeta gráfica de desktop en la arquitectura Pascal y el proceso de la tecnología 16 nm priméramente desarrollada para los jugadores. Posee una memoria de 4 GB de memoria GDDR5 en la frecuencia de 7 GB/s y con la interfaz de 128 Bit posee un ancho de banda de 112 GB/s.", 50000,'img/1050ti.png', 1);
const prod4 = new Productos("4", "Monitor Curvo de Gaming ROG Strix", "Monitor", "Monitor Curvo de Gaming ROG Strix XG27VQ: 27 pulgadas, Full HD (1920x1080), 144Hz, Extreme Low Motion Blur, Adaptive-Sync (FreeSync™)", 90000,'./img/monitor.png', 2);
const prod5 = new Productos("5", "Teclado HyperX Alloy CORE RGB Gaming", "teclado", "Teclado HyperX Alloy CORE RGB Gaming", 50000,'img/tecladohyperx.png', 2);
const prod6 = new Productos("6", "G502 HERO - Logitech G", "mouse", "G502 HERO dispone de un sensor óptico avanzado para máxima precisión de seguimiento, iluminación RGB personalizada, perfiles de juego personalizados, de 200 a 25.600 dpi y pesas reposicionables. 11 botones Totalmente programable4.", 50000,'img/mouseG502hero.png', 2);
